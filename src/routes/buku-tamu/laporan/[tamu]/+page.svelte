<script>
	...
	const tanggal = waktu(data.tanggal.tamu);
...
<section class="p-3">
	...
	<div class="px-3 mb-4">
		<div class="mb-3 text-center">
			<label for="" class="mb-1">Petugas Patroli</label>
			<img src={alan} alt="" class="img-thumbnail rounded-5 p-3" />
			<h6 class="mt-2">Imran Mokodompit</h6>
		</div>
		<div class="mb-3">
